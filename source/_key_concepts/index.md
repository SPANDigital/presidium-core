...
{% comment %}
The Key Concepts section provides a brief explanation of the key concepts employed in the solution. A diagram may be necessary to show how these concepts interact. 
{% endcomment %}
